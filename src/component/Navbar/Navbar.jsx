  ...
  return (
    <nav className="flex-div">
      <div className="nav-left flex-div">
        <img src={menu_icon} alt="menu icon image" className="menu-icon" onClick={()=>setSidebar((prev)=> prev===false?true:false)}/>
        <svg
      ...
      <div className="nav-right flex-div">
        ...
        <img src={profile_image} alt="profile image" className="user-icon" />
      </div>
    </nav>
  );
};
